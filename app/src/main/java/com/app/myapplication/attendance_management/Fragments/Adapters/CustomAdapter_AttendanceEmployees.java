...
public class CustomAdapter_AttendanceEmployees extends RecyclerView.Adapter<CustomAdapter_AttendanceEmployees.ViewHolder> {
    private OnClickListener Listener;
    private final Context context;
    private final ArrayList<Employee> employees;

    public CustomAdapter_AttendanceEmployees(OnClickListener Listener,Context context, ArrayList<Employee> employees) {
    ...
    @NonNull
    @Override
    public CustomAdapter_AttendanceEmployees.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view =inflater.inflate(R.layout.attendance_employee_recycle_view,parent,false);
        return  new CustomAdapter_AttendanceEmployees.ViewHolder(view);
    }
